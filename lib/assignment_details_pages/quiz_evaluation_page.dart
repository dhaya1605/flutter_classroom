...
class quiz_evaluation extends StatefulWidget {
  quiz_evaluation(this.classroomId,this.quizTitle,this.email);
  String classroomId;
  String quizTitle;
  String email;
  @override
  _quiz_evaluationState createState() => _quiz_evaluationState(classroomId,quizTitle,email);
}

class _quiz_evaluationState extends State<quiz_evaluation> {
  _quiz_evaluationState(this.classroomId,this.quizTitle,this.email);
  String classroomId;
  String quizTitle;
  String email;
  String time;
                  ...
                  Column(
                    children: <Widget>[
                      ...
                      RaisedButton(
                        ...
                        onPressed: ()async{
                          await Firestore.instance.collection('classrooms').document(classroomId).collection('quiz').document(quizTitle).collection('submissions').document(email).updateData({
                            'points':points,
                            'total':total,
                            'evaluated': true,
                          });
